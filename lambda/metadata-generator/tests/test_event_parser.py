...
def test_parse_eventbridge_format():
    ...
    event = {
        ...
        "source": "aws.s3",
        "detail": {"bucket": {"name": "test-bucket"}, "object": {"key": "test-file.txt"}},
    }
...
def test_parse_eventbridge_format_nested_path():
    ...
    event = {
        "detail": {
            ...
            "object": {"key": "documents/2024/report.pdf"},
        }
    }
...
def test_parse_direct_invocation_format():
    ...
    event = {"bucket": "test-bucket", "key": "test-file.txt"}
...
def test_parse_direct_invocation_with_nested_path():
    ...
    event = {"bucket": "my-bucket", "key": "path/to/nested/file.csv"}
...
def test_missing_detail_returns_none():
    ...
    event = {"version": "0", "id": "test-event-id"}
...
def test_missing_bucket_in_detail_returns_none():
    ...
    event = {"detail": {"object": {"key": "test-file.txt"}}}
...
def test_missing_bucket_name_returns_none():
    ...
    event = {"detail": {"bucket": {}, "object": {"key": "test-file.txt"}}}
...
def test_missing_object_in_detail_returns_none():
    ...
    event = {"detail": {"bucket": {"name": "test-bucket"}}}
...
def test_missing_object_key_returns_none():
    ...
    event = {"detail": {"bucket": {"name": "test-bucket"}, "object": {}}}
...
def test_eventbridge_takes_precedence_over_direct():
    ...
    event = {
        ...
        "detail": {
            ...
            "object": {"key": "eventbridge-key.txt"},
        },
    }
...
def test_parse_with_special_characters_in_key():
    ...
    event = {"bucket": "test-bucket", "key": "files/test file with spaces.txt"}
...
def test_parse_with_unicode_in_key():
    ...
    event = {"bucket": "test-bucket", "key": "documents/レポート.txt"}
